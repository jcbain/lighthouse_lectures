...
rlp.questionAsync("What do you think of Node.js? ")
  ...
  .then((answer) => {
    answers.push(answer);
    return rlp.questionAsync("What's your favorite activity? ");
  })
  .then((answer) => {
    answers.push(answer);
  ...
  .then((answer) => {
    answers.push(answer);
    return rlp.questionAsync("Which meal is your favorite? ");
  })
  .then((answer) => {
    answers.push(answer);
    return rlp.questionAsync("What's your favorite thing to eat for that meal? ");
  })
  .then((answer) => {
    answers.push(answer);
    return rlp.questionAsync("Which sport is your absolute favorite? ");
  })
  .then((answer) => {
    answers.push(answer);
    rlp.close();
